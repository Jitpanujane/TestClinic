...
namespace Project.Domain.Helpers.Pagination.Installer
{
    ...
    {
        public static string query_sp_pagination { get; } = @"select 1 as Id,COUNT(*) as count_store from information_schema.routines where routine_type = 'PROCEDURE' AND ROUTINE_NAME = 's_Pagination'";

        public static string query_sp_pagination_json { get; } = @"select 1 as Id,COUNT(*) as count_store from information_schema.routines where routine_type = 'PROCEDURE' AND ROUTINE_NAME = 's_PaginationJSON'";

        public static string create_sp_pagination { get; } = @"
           CREATE PROCEDURE [dbo].[s_Pagination]
            ...
            END
        ";
        public static string create_sp_pagination_json { get; } = @"
